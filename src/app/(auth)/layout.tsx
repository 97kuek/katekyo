...
const FEATURES = [
  { icon: "📋", text: "宿題の提出・承認・差し戻しをシンプルに管理" },
  { icon: "📊", text: "テスト成績を記録してグラフで推移を可視化" },
  { icon: "🌳", text: "頑張りが森に育つ「学習の森」でモチベーション維持" },
  { icon: "💬", text: "承認・差し戻し・授業リマインダーを LINE で自動通知" },
]
...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* ブランドパネル */}
      <div className="bg-[#2e743a] text-white flex flex-col justify-center px-8 py-10 md:w-1/2 md:min-h-screen">
      ...
      {/* フォームパネル */}
      <div className="flex flex-col items-center justify-center px-4 py-10 bg-gray-50 md:w-1/2 md:min-h-screen">
