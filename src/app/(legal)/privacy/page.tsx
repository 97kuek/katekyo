  ...
  return (
    <article className="prose prose-sm max-w-none text-foreground">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed mb-2">本サービスは以下の情報を収集・保存します。</p>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed mb-2">サービス提供のため、以下の外部サービスを利用しています。</p>
        <ul className="text-sm space-y-1 list-disc list-inside">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed">
          プライバシーに関するお問い合わせは <a href="mailto:ueki.keitaro@gmail.com" className="text-primary underline">ueki.keitaro@gmail.com</a> までご連絡ください。
        </p>
      </section>
    </article>
  )
