  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="LINE通知・Meet連携">
        <p>「設定」→「LINE連携を開始する」で12桁の連携コードを公式アカウントに送ると、提出通知や週次サマリーが届きます。MeetのパーソナルルームURLを登録すると授業カードに参加ボタンが表示され、オンライン授業の10分前に生徒へリンクが自動送信されます。</p>
      </SectionCard>
    </div>
  )
}
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="LINE通知を設定する">
        <p>「設定」→「LINE連携を開始する」で12桁の連携コードをkatekyoの公式アカウントに送ると連携完了です。宿題の承認・差し戻しや毎朝の期限リマインダー、オンライン授業10分前のMeetリンクが届きます。</p>
      </SectionCard>
    </div>
  )
}
